...
用法：
    python version_manager.py --action list --slug zhang-shifu --base-dir ./father-in-laws
    python version_manager.py --action rollback --slug zhang-shifu --version v2 --base-dir ./father-in-laws
"""
...
def main():
    parser = argparse.ArgumentParser(description="老丈人 Skill 版本管理器")
    parser.add_argument("--action", required=True, choices=["list", "rollback", "cleanup"])
    parser.add_argument("--slug", required=True, help="老丈人 slug")
